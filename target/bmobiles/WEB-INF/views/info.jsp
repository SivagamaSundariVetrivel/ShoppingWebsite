...
<form:textarea path="comment" class="form-control block" placeholder="Please leave your comment here..."/><br>

 <div class="row">
<div class="col-sm-11" align="right">
<c:choose>
<c:when test="${pageContext.request.userPrincipal.name}!=null">
<form:input disabled="true" path="userName"  class="form-group" value="${pageContext.request.userPrincipal.name}"/>
</c:when>
<c:when test="${pageContext.request.userPrincipal.name}==null">
<p class="form-group" >Please Login to leave a comment here..</p>
</c:when>
</c:choose>
<%-- <c:if test="${pageContext.request.userPrincipal.name}!=null"> --%>
<%-- <form:input class="form-group" path="userName" placeholder="Username please"/> --%>
<%-- </c:if> --%>
</div>
<div class="col-sm-1">

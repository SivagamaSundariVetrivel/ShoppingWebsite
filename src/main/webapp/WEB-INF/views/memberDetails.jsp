  ...
  <body>
   ...
   <sf:form modelAttribute="userBean" role="form" class="form-group">
	...
	<div class="row">
	 ...
	 <div  class="col-sm-6">
      <sf:input path="userName"  type="text" class="form-control" name="userName" id="username"/>
	 ...
	 <div  class="col-sm-6">
     <sf:input path="password" type="password" name="password" class="form-control" id="pwd"/>
     <!-- to display validation messages -->
